...
import com.neerajweb.gcmgreetingapp.R;
    ...
    private void registerViews() {
        ...
        this.bSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (checkValidation())
                    ...
                    Toast.makeText(activity_register_main.this, "Form contains error", Toast.LENGTH_LONG).show();
            }
        });
        ...
        tvLoginLink.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(activity_register_main.this, Login.class);
