...
public class Greeting_registration_activity extends base_activity_main {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//setContentView(R.layout.greeting_registration_activity);

		/**
		 * Adding our layout to parent class frame layout.
		 */
		getLayoutInflater().inflate(R.layout.greeting_registration_activity, frameLayout);
		...
		if (!TextUtils.isEmpty(registrationId)) {
			Intent i = new Intent(applicationContext, receive_greeting_activity.class);
				...
				new AsyncHttpResponseHandler() {
					...
					public void onSuccess(String response) {
						...
						Intent i = new Intent(applicationContext,
								receive_greeting_activity.class);
