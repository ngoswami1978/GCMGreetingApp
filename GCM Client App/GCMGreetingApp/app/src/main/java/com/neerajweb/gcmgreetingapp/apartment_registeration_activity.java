...
import com.neerajweb.gcmgreetingapp.adapter.SpinnerFlatsAdapter;
import com.neerajweb.gcmgreetingapp.dao.FlatDAO;
import com.neerajweb.gcmgreetingapp.dao.OwnerDAO;
import com.neerajweb.gcmgreetingapp.model.owner_model;
import com.neerajweb.gcmgreetingapp.model.flat_model;
 ...
 */
public class apartment_registeration_activity extends base_activity_main implements OnItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setContentView(R.layout.apartment_registeration_activity);
         ...
         */
        getLayoutInflater().inflate(R.layout.apartment_registeration_activity, frameLayout);
        ...
        try
        {
            ...
            if (!cd.isConnectingToInternet()) {
                ...
                alert.showAlertDialog(apartment_registeration_activity.this, "Internet Connection Error",
    ...
    private void registerViews() {
        ...
        this.bSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (checkValidation())
                    ...
                    Toast.makeText(apartment_registeration_activity.this, "Form contains error", Toast.LENGTH_LONG).show();
            }
        });
        ...
        tvLoginLink.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(apartment_registeration_activity.this, apartment_login.class);
