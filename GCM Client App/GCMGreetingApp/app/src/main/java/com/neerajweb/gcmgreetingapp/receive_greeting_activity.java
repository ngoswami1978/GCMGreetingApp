...
public class receive_greeting_activity extends base_activity_main {
	TextView emailET;
	private AQuery aq;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//setContentView(R.layout.receive_greeting_activity);

		/**
		 * Adding our layout to parent class frame layout.
		 */
		getLayoutInflater().inflate(R.layout.receive_greeting_activity, frameLayout);
